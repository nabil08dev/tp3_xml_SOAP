 ...
 * 
 */
@WebServiceClient(name = "BankWS", targetNamespace = "http://ws.example.org/", wsdlLocation = "http://localhost:8686/?wsdl")
public class BankWS
    extends Service
{
    ...
    private static final QName BANKWS_QNAME = new QName("http://ws.example.org/", "BankWS");
    ...
    public BankAccountService getBankAccountServicePort() {
        return super.getPort(new QName("http://ws.example.org/", "BankAccountServicePort"), BankAccountService.class);
    }
    ...
    public BankAccountService getBankAccountServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.example.org/", "BankAccountServicePort"), BankAccountService.class, features);
    }
